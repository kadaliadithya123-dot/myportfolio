  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          className={`px-3 sm:px-6 py-2.5 rounded-2xl transition-all duration-300 ${scrolled
        ...
        >
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
              ...
              <button
                ...
                onMouseEnter={playHover}
                className="flex items-center gap-1 px-2.5 sm:px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-neon-cyan to-blue-600 text-black font-semibold text-[11px] sm:text-xs hover:brightness-110 shadow-neon-cyan transition-all whitespace-nowrap"
              >
          ...
          <nav className="mt-2 -mx-1 overflow-x-auto scrollbar-hide" aria-label="Primary navigation">
