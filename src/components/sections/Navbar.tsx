        ...
        >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              onMouseEnter={playHover}
              className="flex items-center gap-1 px-2.5 sm:gap-1.5 sm:px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-neon-cyan to-blue-600 text-black font-semibold text-[11px] sm:text-xs hover:brightness-110 shadow-neon-cyan transition-all whitespace-nowrap"
            >
